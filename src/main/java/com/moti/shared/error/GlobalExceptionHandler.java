...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CommonResponse<Map<String, String>>> handleBindException(org.springframework.validation.BindException e) {
    ...
    public ResponseEntity<CommonResponse<Map<String, String>>> handleMethodValidationException(HandlerMethodValidationException e) {
        Map<String, String> errorMap = new HashMap<>();
    ...
    @ExceptionHandler(MotiException.class)
    public ResponseEntity<CommonResponse<String>> handleMotiException(MotiException e) {
        logHandledException(e);
